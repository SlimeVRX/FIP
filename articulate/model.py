...
class ParametricModel:
    ...
    def view_mesh(self, vertex_list: list, fps=60, distance_between_subjects=0.8,contact=None,isDiff=False):
        r"""
        ...
        faces = np.concatenate(f_list)
        if verts.shape[0] > 1:
            vo3d.render_sequence_3d(verts, faces, 720, 720, '/home/lab1111/xd/code/FDIP/a.mp4', fps, visible=True, contact=contact,isDiff=isDiff)
        else:
            vo3d.vis_mesh(verts[0], faces)

    def view_motion(self, pose_list: list, tran_list: list = None, fps=60, distance_between_subjects=0.8, contact=None, isDiff=False):
        r"""
        ...
        self.view_mesh(verts, fps, distance_between_subjects=distance_between_subjects, contact=contact, isDiff=isDiff)
